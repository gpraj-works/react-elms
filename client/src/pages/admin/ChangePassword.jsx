//prettier-ignore
import { Box, Stack, Typography, Button, FormControl, InputLabel, OutlinedInput, IconButton, InputAdornment } from '@mui/material';
...
const ChangePassword = () => {
	...
	const updatePassword = async (e) => {
		e.preventDefault();
		try {
			await server.put('/admin/change-password', { password });
